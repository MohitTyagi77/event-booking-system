...
- Real-time seat availability broadcast with Socket.IO
...
- **EventDetails**: event info, Google Maps embed, ticket selector, total price
- **Checkout**: animated form + booking request + QR ticket generation on success
